...
3. **Stakeholder Communication:**  Transparency is crucial.  Communicate the findings, the revised plan, and the rationale behind it to *all* stakeholders – the product owner, the development team, the QA team, and any relevant business representatives. Avoid jargon and present the information in a clear, concise manner.
